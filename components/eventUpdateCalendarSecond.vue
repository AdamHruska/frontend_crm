...
const handleConfirmEvent = async () => {
	...
	try {
		...
		toast.success("Analýza osobných financií bola vytvorená");
	} catch (error) {
	...
	>
		...
		>
			...
			<div class="form-grid">
				...
				<!-- col 2 (or full): Online Meeting + extra emails -->
				<div
				...
				>
					<div class="flex items-center gap-3 mb-2">
						<input
							...
							type="checkbox"
							class="bg-slate-700 rounded-lg focus:outline-blue-500"
						/>
				...
				<div class="flex justify-end span-2" v-if="officeActivity">
					<div
						...
						:class="{
							'opacity-50 pointer-events-none': deletingOfficeActivity,
						}"
					>
				...
				<!-- col 1: VDD (only for phone types) -->
				<div
					class="relative z-0 w-full group"
					v-if="
						aktivita == 'Telefonát' ||
