...
<template>
	...
	>
		...
		>
			...
			<!-- Contact search — full width, outside grid -->
			<div class="mb-4">
			...
			<!-- Email for online meeting — full width, outside grid -->
			<div v-if="onlineMeeting" class="mb-4">
				<label class="text-sm text-gray-400">Pridať email ku kontaktu:</label>
				<input
					v-model="emails[0]"
					type="email"
				...
				<div class="relative z-0 w-full group">
					...
					<div class="flex items-center gap-3 mt-2">
						<input
							...
							type="checkbox"
							class="bg-gray-200 rounded-lg focus:outline-blue-500"
							value="true"
						/>
						<label class="!text-black text-sm">Online Meeting</label>
						<div
							@click="emailCount++"
							class="cursor-pointer ml-auto transition-all duration-200 hover:scale-110"
				...
				<div class="relative z-0 w-full group" v-if="showVDD">
					...
					<div class="flex justify-between px-2">
						<label class="cursor-pointer flex flex-col items-center gap-3">
							<span class="text-sm font-medium text-gray-900">Volané</span>
							<input
								type="checkbox"
								value="1"
								class="sr-only peer"
						...
						<label class="cursor-pointer flex flex-col items-center gap-3">
							<span class="text-sm font-medium text-gray-900">Dovolané</span>
							<input
								type="checkbox"
								value="1"
								class="sr-only peer"
						...
						<label class="cursor-pointer flex flex-col items-center gap-3">
							<span class="text-sm font-medium text-gray-900">Dohodnuté</span>
							<input
								type="checkbox"
								value="1"
								class="sr-only peer"
